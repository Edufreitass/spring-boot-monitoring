package com.medium.monitoring.springbootmonitoring.api.controller;

import com.medium.monitoring.springbootmonitoring.domain.model.Person;
import com.medium.monitoring.springbootmonitoring.infrastructure.repository.PersonRepository;
...
public class PersonController {
    ...
    public ResponseEntity<List<Person>> findByLastName(@PathVariable String lastName) {
        return new ResponseEntity<>(personRepository.findByLastNameIgnoringCase(lastName), HttpStatus.OK);
    }
